...
Breve descrição da automação para engenharia civil.

![Demonstração do Sistema](junta_detalhe.png)

### Funcionalidades:
- Automação de propostas de serviço.
- Controle de impermeabilização e patologias.
